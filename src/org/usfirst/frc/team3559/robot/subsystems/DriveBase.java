...
public class DriveBase extends Subsystem {
    ...
    public void moveAhead(double count){
    	leftMotor.setVoltageRampRate(3);
    	rightMotor.setVoltageRampRate(3);
    	leftMotor.changeControlMode(TalonControlMode.Position);
    	leftMotor.setPID(0.07, 0.0, 0.0);
    	leftMotor.enableControl();
    	leftMotor.reverseOutput(false);
    	rightMotor.reverseOutput(true);
    	rightMotor.changeControlMode(TalonControlMode.Position);
    	rightMotor.setPID(0.07, 0.0, 0.0);
    	rightMotor.enableControl();
    	rightMotor.set(count);
    	leftMotor.set(count);
    	
    }
    public void turnRight(double count){
    ...
    public void turnLeft(double count) {
